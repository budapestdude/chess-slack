...
/**
 * Chess Piece Icon Components
 * SVG-based chess pieces for UI decoration
 */

export const KingIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" fill="currentColor" stroke="currentColor" strokeLinecap="butt" strokeLinejoin="miter"/>
      <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 11.5,37 z" fill="currentColor" stroke="currentColor"/>
...
export const QueenIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const RookIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BishopIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const KnightIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const PawnIcon: React.FC<ChessPieceIconProps> = ({ className = 'w-6 h-6', color = 'black' }) => (
  <svg viewBox="0 0 45 45" className={`${className} ${colorClasses[color]}`}>
    <g fill="currentColor" fillRule="evenodd" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/**
 * ChessPieceIcon - Dynamic chess piece selector
 */
interface DynamicChessPieceProps extends ChessPieceIconProps {
  piece: 'king' | 'queen' | 'rook' | 'bishop' | 'knight' | 'pawn';
}

export const ChessPieceIcon: React.FC<DynamicChessPieceProps> = ({ piece, ...props }) => {
  const pieces = {
    king: KingIcon,
    queen: QueenIcon,
    rook: RookIcon,
